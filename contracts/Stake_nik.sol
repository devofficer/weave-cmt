    ...
    import { IPancakeRouter02, IPancakeFactory } from "./pancakeRouter.sol";
    ...
    contract Stake is Ownable {
        ...
        // User addresses that accepted to be upfront LP
        address[] public upfrontUsers;
        ...
        constructor(
            ...
            pancakeV2Router = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // testent
        }
        ...
        function currentReward(address _user) external view returns (uint256) {
            return _calculateReward(_user, rewardStartNumber, block.number);
        }
        ...
        // Deposit BUSD tokens and agree to upfront
        function depositAndPair(uint256 _amount) public {
            deposit(_amount);
            upfrontUsers.push(msg.sender);
        }
        ...
        function claimRewards() public {
            ...
            uint256 totalClaim = _calculateReward(msg.sender, rewardStartNumber, rewardEndNumber);
        ...
        function _calculateReward(address user, uint256 startBlock, uint256 endBlock) private view returns(uint256) {
            uint256 allocation;
            uint256 blcNumber;
            uint256 totalAlloc;
        ...
        // Pair function to become liquidity provider
        function _pairBusdWeave(address _provider) private {
            uint256 rewardDesired = _calculateReward(
                upfrontUsers[i],
                rewardStartNumber,
                rewardEndNumber
            );
        ...
        function startReward() public onlyOwner {
            ...
            rewardEndNumber = rewardPeriod.mul(28800).add(rewardStartNumber);
