...
import {IPancakeRouter02,IPancakeFactory} from "./pancakeRouter.sol";
    ...
    contract Stake is Ownable {
        ...
        //add liquidity function for weave/busd
        function _addWeaveBusdLiquidity(uint256 _weaveTokenAmount,uint256 _busdTokenAmount) internal {
            pancakeV2Router.addLiquidity(address(weave), address(busd),
                                        _weaveTokenAmount, _busdTokenAmount,
                                        _weaveTokenAmount, _busdTokenAmount, 
                                        owner(), block.timestamp +60*10);
        }
